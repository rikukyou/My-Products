...
local sndLose = audio.loadSound ( "GameOver.mp3" )
...
local function createPlayScreen()
	...
	planet = display.newImage("flower.png")
	planet.x = centerX
...
function spawnEnemy()
	local enemypics = {"bee2.png","butterfly2.png", "ladybug3.png"}
...
function startGame()
	local text = display.newText( "Tap here to start. Protect the flower!", 0, 0, "Helvetica", 24 )
	text.x = centerX
	text.y = display.contentHeight - 30
	text:setTextColor(255, 51, 51)
